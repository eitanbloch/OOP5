...
typedef GameBoard< List<
        ...
        List < BoardCell< EMPTY , RIGHT , 3>, BoardCell< EMPTY , RIGHT , 6>, BoardCell< X , RIGHT , 2>, BoardCell< X , LEFT , 2>, BoardCell< O , UP , 3>, BoardCell< EMPTY , RIGHT , 0> >,
